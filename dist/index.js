...
var O=require('@stdlib/assert-is-wasm-memory/dist'),y=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),S=require('@stdlib/utils-inherit/dist'),q=require('@stdlib/wasm-module-wrapper/dist'),g=require('@stdlib/error-tools-fmtprodmsg/dist'),j=d();function s(e){if(!(this instanceof s))return new s(e);if(!O(e))throw new TypeError(g('22lH0',e));return q.call(this,j,e,{env:{memory:e}}),this}S(s,q);y(s.prototype,"main",function(r,i,t){return this._instance.exports.c_sasum(r,i,t)});y(s.prototype,"ndarray",function(r,i,t,o){return this._instance.exports.c_sasum_ndarray(r,i,t,o)});m.exports=s
