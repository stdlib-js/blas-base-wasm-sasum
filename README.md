...
```javascript
sasum = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-sasum-wasm@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var sasum = require( 'path/to/vendor/umd/blas-base-sasum-wasm/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-sasum-wasm@umd/browser.js"></script>
```
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-base-sasum-wasm.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-base-sasum-wasm/main
