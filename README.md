...
```javascript
import sasum from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-sasum@v0.0.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { Module } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-sasum@deno/mod.js';
```
